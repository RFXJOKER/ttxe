...
oot_channel_id_list = ["696349778484920330",  #galaxy
"705421948171190343",
"568617830258442255",
"693960182803333150",
"459842150323060736",
...
answer_pattern = re.compile(r'(went|w)?([1-3]{1})(\?)?(cnf|c|conf)?(\?)?$', re.IGNORECASE)
...
#         lowest = min(lst_scores)
        ...
        best_answer="Fetching:- <a:loadinggoogel:708646509230424065>"
        if highest >0:
          if answer ==1:
            one_check="<a:tickblue:708646429031399485>"
          ...
          if answer==1:
            ...
            bold1=""
          if answer ==2:
            two_check="<a:tickblue:708646429031399485>"
          ...
          if answer ==3:
            three_check="<a:tickblue:708646429031399485>"
        ...
        self.embed=discord.Embed(title="__HQ CROWD RESULT!__", description=f"Answer 1 : {lst_scores[0]}{one_check}{bold1}\nAnswer 2 : {lst_scores[1]}{two_check}{bold2}\nAnswer 3 : {lst_scores[2]} {three_check}{bold3}\n**__Crowd Result:-__**\n{best_answer}\n",color=0x8A2BE2)
       #self.embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/644795828296482818/702562680703156234/image_search_1587574383656.jpg")
        self.embed.set_footer(text=f"Made By Akhil",icon_url="")
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Activity(type=2,name="HQ Answer | +hp"))
        await asyncio.sleep(5)
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NzA4MDMyNDM3MzUwOTU3MTM2.XrRcvg.RKpo1Axto_7rhnsxfpxZ6GbhP4o'))
    loop.run_forever()
...
def selfbot_process(update_event, answer_scores):
    ...
    loop = asyncio.get_event_loop()
    loop.create_task(selfbot.start('Njk1MTI0NTE1NjcxMjQ0ODEw.XrWwTg.J56rWTm-7RtAcDyeGcY_Z0uWXQQ',
                                   bot=False))
    loop.run_forever()
